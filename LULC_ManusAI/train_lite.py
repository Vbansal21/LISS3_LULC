...
from scripts.data_preprocessing import UCMercedDataset, ESAWorldCoverDataset, LandsatDataset
...
def create_dataloaders(args):
    ...
    if args.task == 'landcover':
        ...
        transform = transforms.Compose([
            ...
            transforms.Resize((128, 128))  # Resize to smaller dimensions to save memory
        ])
...
def main():
    ...
    args = ['--task', 'landcover', '--epochs', '5', '--batch-size', '2']
    args = parse_args()
    ...
    for epoch in range(args.epochs):
        ...
        # Validate
        val_loss = validate(model, val_loader, criterion, device, args.task)
